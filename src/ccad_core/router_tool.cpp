...
void RouterTool::commitRouting() {
  ...
  // PNS index is rebuilt for future candidate acceleration, but cannot reject
  // a route by itself: its broad candidate query may conservatively include
  // clear segments. Exact pad/via/track/zone/arc geometry below is authoritative.
