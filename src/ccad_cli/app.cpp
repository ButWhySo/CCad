  ...
  static const std::vector<CommandHelp> commands{
      ...
      CommandHelp{.name = "pcb set-layer",
                  ...
                  .usage = "ccad pcb set-layer --file <path> --id <id> --name <name> "
                           "--kind <kind> --visible true|false"},
      CommandHelp{.name = "pcb load-state",
                  .summary = "Report KiCad-style board loader initialization state",
                  .usage = "ccad pcb load-state --file <path> [--initialize true|false]"},
      CommandHelp{.name = "pcb drill-statistics",
                  .summary = "Report KiCad-style grouped board drill holes",
                  .usage = "ccad pcb drill-statistics --file <path>"},
      CommandHelp{.name = "pcb board-statistics",
                  .summary = "Report KiCad-style board statistics summary",
                  .usage = "ccad pcb board-statistics --file <path>"},
      CommandHelp{.name = "pcb export-board-bom",
                  .summary = "Export KiCad-style board Bill of Materials as CSV",
                  .usage = "ccad pcb export-board-bom --file <path> --output <path.csv>"},
      CommandHelp{.name = "pcb cleanup-actions",
                  .summary = "List KiCad-style PCB cleanup action rows",
                  .usage = "ccad pcb cleanup-actions"},
      CommandHelp{.name = "pcb collect-items",
                  .summary = "Collect KiCad-style board item rows for selection and agent tools",
                  .usage = "ccad pcb collect-items --file <path> --scan-set <name> "
                           "[--preferred-layer <id>] [--visible-layers <ids>] "
                           "[--include-secondary true|false] [--ignore-tracks true|false]"},
      ...
      CommandHelp{.name = "pcb calculate-net-bridges",
                  .summary = "Calculate and list component bridges between pads on a given net",
                  .usage = "ccad pcb calculate-net-bridges --file <path> --net <net>"},
      ...
      CommandHelp{.name = "pcb outline-polygon",
                  .summary = "Report KiCad-style Edge.Cuts outline polygon state",
                  .usage = "ccad pcb outline-polygon --file <path> [--infer true|false]"},
      CommandHelp{.name = "pcb cross-probe",
                  .summary = "Resolve one KiCad-style PCB/schematic cross-probe packet",
                  .usage = "ccad pcb cross-probe --file <path> --packet <packet>"},
      ...
      CommandHelp{.name = "pcb add-group",
                  ...
                  .usage = "ccad pcb add-group --file <path> --id <id> [--name <name>] [--members <comma-separated-ids>]"},
      CommandHelp{.name = "pcb add-reference-image",
                  .summary = "Adds a reference image to the board.",
                  .usage = "ccad pcb add-reference-image --file <path> --id <id> --layer <id> --data <base64> --x-mm <n> --y-mm <n> --scale <n> --opacity <n>"},
      CommandHelp{.name = "pcb add-table",
                  .summary = "Adds a table to the board.",
                  .usage = "ccad pcb add-table --file <path> --id <id> --layer <id> --x-mm <n> --y-mm <n> --rows <n> --cols <n> --width-mm <n> --height-mm <n>"},
      ...
      CommandHelp{.name = "project set-text-variable",
                  .summary = "Set one KiCad-style project text variable",
                  .usage = "ccad project set-text-variable --file <path> --key <name> --value <text>"},
      CommandHelp{.name = "project list-text-variables",
                  .summary = "List KiCad-style project text variables",
                  .usage = "ccad project list-text-variables --file <path>"},
