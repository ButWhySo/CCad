...
const QVector<AgentProviderSpec>& agentProviderSpecs() {
  static const QVector<AgentProviderSpec> specs = {
      ...
      {"openrouter",
       "OpenRouter API",
       "openrouter_api",
       {"OPENROUTER_API_KEY", "CCAD_OPENROUTER_MODEL"},
       "CCAD_OPENROUTER_MODEL",
       "OpenRouter exposes a dynamic model catalog; use official API access and review routing/provider terms."},
      {"cerebras",
       "Cerebras API",
       "cerebras_api",
...
void AgentPanel::setProviderSecretResultCallback(ProviderSecretResultCallback cb) {
    provider_secret_result_cb_ = std::move(cb);
}
