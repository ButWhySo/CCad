        ...
        "methods": [
            ...
            {"name": "agent.memory_add", "read_only": False, "secrets": True,
             ...
             "params": {"tier": {"type": "string", "enum": ["stm", "ltm", "episodic"]},
                        ...
                        "importance": {"type": "integer", "minimum": 1, "maximum": 5,
                                       "default": 3,
                                       "description": "User-selected ranking importance; 3 is neutral"},
                        "content": {"type": "string", "secret_rejected": True}},
             "response": {"method": "memory_added", "fields": [
                 "id", "tier", "scope", "kind", "importance", "secret_value_visible"]}},
            {"name": "agent.memory_update", "read_only": False, "secrets": True,
             ...
             "params": {"id": {"type": "string"},
                        ...
                        "importance": {"type": "integer", "optional": True,
                                       "minimum": 1, "maximum": 5}},
             "response": {"method": "memory_updated", "fields": [
                 "id", "updated", "kind", "importance", "secret_value_visible"]}},
             ...
             "response_contracts": {
                ...
                "tool_call": {"fields": [
                 ...
                 "context_state": {"fields": [
                     ...
                     "project_retrieval_block_net_count"]}},
