...
- [x] Sprint 968: explicit task-scoped STM, bounded session/task cache, lexical near-duplicate guard, 99/99 CTest, inspected 8-action GUI-map flow, >20-second GUI stability run, secret scan, commit, and push verified. Later Sprint 970 implements semantic conversation-history compaction; durable memory-record semantic compaction remains open.
