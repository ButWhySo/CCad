...
- [x] Sprint 975: truthful Agent memory add/update/delete UI outcomes, safe confirmed deletion across thread switches, isolated GUI-map lifecycle validation, and correction of the visible GUI-map privacy-test fixture.
