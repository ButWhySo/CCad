...
- [ ] Sprint 245 and onward library batch audit: continue alphabet/folder-bounded library comparison until every cached KiCad library file has reproducible evidence and structured unsupported diagnostics.
...
- [ ] Stub: `pcb_barcode.cpp` (Barcode rendering)
- [ ] Stub: `pcb_design_block_utils.cpp` (Design blocks)
- [ ] Stub: `pcb_dimension.cpp` (Dimensioning objects)
- [ ] Stub: `pcb_field.cpp`, `pcb_fields_grid_table.cpp` (Property fields)
- [ ] Stub: `pcb_generator.cpp` (Plugin generators)
- [ ] Stub: `pcb_group.cpp` (Object grouping)
- [ ] Stub: `pcb_plot*.cpp`, `plot_*.cpp` (Gerber, PDF, SVG plotting)
- [ ] Stub: `pcb_reference_image.cpp` (Reference image overlays)
- [ ] Stub: `pcb_table.cpp`, `pcb_tablecell.cpp` (Table objects)
- [ ] Stub: `pcb_target.cpp` (Alignment targets)
- [ ] Stub: `pcb_text.cpp`, `pcb_textbox.cpp` (Standalone text primitives)
- [ ] Stub: `pcbexpr_evaluator.cpp`, `pcbexpr_functions.cpp` (Text substitution engine)


- [ ] Stub: `tracks_cleaner.cpp` (Track merging and cleanup logic)
- [ ] Stub: `zone.cpp`, `zone_filler.cpp`, `zone_settings.cpp`, `zone_utils.cpp` (Copper pours and zone algorithms)
