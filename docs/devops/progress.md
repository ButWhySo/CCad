...
- Status: Sprint 39 merged on `main`; verification running after merge
...
- Sprint 40: planning pending. Use moderate sprint sizing: several related tasks per compile, not one tiny branch per small GUI affordance.
