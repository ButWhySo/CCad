...
Progress counter: Phase 2 / 6, Sprint 49 merged and verified on `main`; Sprint 50 planning. See `docs/devops/progress.md`.
...
- Native GUI canvas supports keyboard navigation: `+`, `-`, `0`, `F`, arrow-key panning, and `W/A/S/D` panning.
