...
Progress counter: Phase 2 / 6, Sprint 35 in progress. See `docs/devops/progress.md`.
...
- Native GUI object browser rows expose stable PCB object IDs for selection linking.
