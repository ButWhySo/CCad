...
- `pcb export-route-job` emits a compact deterministic route-job JSON envelope with board outline, design rules, layers, pads, vias, tracks, keepouts, placement regions, and route requests.
