...
static void testSchematicCollector() {
  ...
  assertEqual(static_cast<int>(report.candidates.size()), 6, "all_items should find 6 components");
  ...
  assertEqual(static_cast<int>(report.candidates.size()), 6, "editable_items should find 6 components");
