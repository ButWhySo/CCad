...
def main():
    ...
    provider_state = send_ui_action('ui.click', {
        'id': 'control:providerCombo', 'value': 'cerebras'
    }).get('result', {})
    ...
    model_state = send_ui_action('ui.click', {
        'id': 'control:modelCombo', 'value': 'gpt-oss-120b'
    }).get('result', {})
